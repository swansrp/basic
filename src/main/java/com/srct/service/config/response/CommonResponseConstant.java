...
public class CommonResponseConstant {
    ...
    public static final CommonResponseCode ACCESS_TOKEN_EXPIRED_OR_INVALID_ERROR = new CommonResponseCode(TAG+"0005", "Access Token Expired Or Invalid Error", HttpStatus.FORBIDDEN);
	public static final CommonResponseCode ACCOUNT_OR_PASSWORD_INCORRECT_ERROR = new CommonResponseCode(TAG+"0004", "Account Or Passwork Incorrect", HttpStatus.UNAUTHORIZED);
	public static final CommonResponseCode USER_NOT_LOGIN_ERROR = new CommonResponseCode(TAG+"0006", "User Not Login Error", HttpStatus.UNAUTHORIZED);
