...
public class DataSourceConfig {
	...
	@ConfigurationProperties(prefix = "config.datasource") // specific the prefix in application.properteis
	 ...
	 * <p>
	 * You need to add @{@code @ConfigurationProperties(prefix = "mybatis")}, if you
	 * are using *.xml file, the {@code 'mybatis.type-aliases-package'} and
