...
public class ${modelName}Controller {
    ...
    @Autowired
    private ${modelName}Dao ${modelNameFL}Dao;
	...
	${modelName} ${modelNameFL} =new ${modelName}(); BeanUtil.copyProperties(vo, ${modelNameFL});
	...
	${modelName} ${modelNameFL} =new ${modelName}(); BeanUtil.copyProperties(vo, ${modelNameFL});
        ...
        PageInfo<${modelName}> ${modelNameFL}List =
				${modelNameFL}Dao.get${modelName}Selective(${modelNameFL}, pageInfo);
    ...
    public ResponseEntity<CommonResponse<QueryRespVO<${modelName}>>.Resp> get${modelName}(
        ...
        QueryRespVO<${modelName}> res = new QueryRespVO<>(); if (id == null) {
            PageInfo pageInfo = DBUtil.buildPageInfo(currentPage, pageSize);
            PageInfo<${modelName}> ${modelNameFL}List =
					${modelNameFL}Dao.getAll${modelName}List(DataSourceCommonConstant.DATABASE_COMMON_IGNORE_VALID,
                            pageInfo); res.getInfo().addAll(${modelNameFL}List.getList());
            res.buildPageInfo(${modelNameFL}List);
        } else {
    ...
    public ResponseEntity<CommonResponse<Integer>.Resp> del${modelName}(@RequestParam(value = "id") Integer id) {
