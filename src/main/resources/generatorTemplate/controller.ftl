...
import ${commonPackage}.config.response.LockScreenExceptionHandler;
...
public class ${modelName}Controller {
	...
	public ResponseEntity<CommonResponse.Resp> update${modelName}(@RequestBody ${modelName}EntityVO vo) {
    ...
    public ResponseEntity<CommonResponse.Resp> get${modelName}Selective(
        ...
        return LockScreenExceptionHandler.generateResponse(res);
    }
    ...
    public ResponseEntity<CommonResponse.Resp> get${modelName}(
        ...
        return LockScreenExceptionHandler.generateResponse(resList);
    }
    ...
    public ResponseEntity<CommonResponse.Resp> del${modelName}(
        ...
        return LockScreenExceptionHandler.generateResponse(delId);
    }
}
